...
Next ==
   ...
   \/ Remote!HandleListFilesStart(Local!UnchangedVars /\ Dialog!UnchangedVars)
   \/ Remote!HandleListFilesDo(Local!UnchangedVars /\ Dialog!UnchangedVars)
   \/ Remote!HandleBlockRequest(Local!UnchangedVars /\ Dialog!UnchangedVars)
